...
class Config(object, metaclass=Singleton):
    ...
    num_sys_haystack = 1 #2 #3 #4 #9 #14 #19 #number of systems in the haystack
    len_seg_haystack = 123 #82 #61 #48 #23 #15 #10 #length of a haystack segment
    ...
    train_int = 240 #number of steps between logging (train interval)
