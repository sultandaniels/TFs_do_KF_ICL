...
class Config(object, metaclass=Singleton):
    ...
    # Dataset settings
    num_tasks = 4000 #number of training systems
    ...
    batch_size = 128 #usually 512 (~35GB) tune this to fit into GPU memory
    ...
    learning_rate = 0.833333*1.584893192461114e-05#1.584893192461114e-05 #1.9054607179632464e-05
    weight_decay = 1e-2
