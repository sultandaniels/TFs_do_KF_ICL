...
class Config(object, metaclass=Singleton):
    ...
    batch_size = 96 #usually 512 (~35GB) tune this to fit into GPU memory
    ...
    learning_rate = np.sqrt((len(devices) * batch_size)/512)*(0.8333333**2)*1.584893192461114e-05#1.584893192461114e-05 #1.9054607179632464e-05
    weight_decay = 1e-2
