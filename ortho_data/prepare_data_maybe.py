...
# =============================================================================
input_filename = '/scratch/users/dhruvgautam/TFs_do_KF_ICL/ortho_data/data/interleaved_traces_ortho_ident_C_state_dim_5_num_sys_haystack_5.pkl'
...
out_dir = '/scratch/users/dhruvgautam/TFs_do_KF_ICL/ortho_data/prune/'  # Change this path to your desired output directory.
