...
if __name__ == "__main__":
    ...
    collect_data(config, "../outputs/GPT2/250124_052617.8dd0f8_multi_sys_trace_ident_state_dim_5_ident_C_lr_1.584893192461114e-05_num_train_sys_40000", only, train_mix_dist)