...
if __name__ == "__main__":
    ...
    collect_data(model, config, "../outputs/GPT2/241231_175136.793356_multi_sys_trace_ortho_state_dim_5_ident_C_lr_1.584893192461114e-05_num_train_sys_40000", only, train_mix_dist)