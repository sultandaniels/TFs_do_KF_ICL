...
if __name__ == "__main__":
    ...
    collect_data(model, config, "../outputs/GPT2/241214_215216.790b07_multi_sys_trace_gaussA_state_dim_10_gauss_C_lr_1.584893192461114e-05_num_train_sys_40000", only, train_mix_dist)