...
import argparse
from dyn_models.linear_data import generate_linear_sample
...
if __name__ == "__main__":
    ...
    collect_data(config, "/data/shared/ICL_Kalman_Experiments/train_and_test_data/linear", only, train_mix_dist, opposite_ortho=opposite_ortho)