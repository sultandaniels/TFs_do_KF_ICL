EDGE_SPARSITIES=(1.011) #0.945 0.95 0.955 0.96 0.965 0.97 0.975 0.985 0.99 0.995 1.0 1.01 1.05 
...
WANDB_MODE=online python src/models/prune/fpt2_ortho_new.py \
    --report_to wandb \
    --do_train \
    --do_eval \
    --dataset_path ./ortho_data/prune/ \
    ...
    --output_dir ./data/runs/one-after-${TAG}-elr${ELR}-llr${LLR}-relr${RELR}-rllr${RLLR}-es${EDGE_SPARSITY}-ns${NODE_SPARSITY}-t${TOTAL}/ \
